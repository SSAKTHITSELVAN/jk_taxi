...
const plans = [
  {
    ...
    perKm: '₹7 – ₹10 / km',
    color: 'yellow',
    features: ['Starting from ₹20 (Bike)', 'Starting from ₹30 (Auto)', 'Best for short city rides', 'Quickest option in traffic', 'No AC, budget-friendly'],
    cta: 'Book Bike / Auto',
    popular: false,
  },
  {
    ...
    perKm: '₹16 / km',
    color: 'purple',
    features: ['Base fare: ₹120', '₹16 per km', 'Full AC comfort', 'City & airport rides', 'Outstation available'],
    cta: 'Book Sedan',
    popular: true,
  },
  {
    icon: '🚐',
    name: 'SUV / Premium',
    tagline: 'Group & luxury',
    base: 180,
    baseLabel: 'From',
    perKm: '₹22 – ₹28 / km',
    color: 'blue',
    features: ['SUV from ₹180', 'Premium from ₹250', 'Up to 7 seats', 'Extra luggage space', 'Premium interiors'],
    cta: 'Book SUV',
    popular: false,
  },
]
